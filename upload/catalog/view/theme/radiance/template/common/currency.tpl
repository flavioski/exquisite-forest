...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-currency" class="hidden-xs">
  <div class="btn-group">
    ...
    <?php } ?>
    <?php } ?>
    <span class="hidden-xs hidden-sm hidden-md"><?php echo $code; ?></span> <i class="hidden-xs fa fa-caret-down"></i></button>
  ...
  <input type="hidden" name="code" id="currencyValue" value="" />
