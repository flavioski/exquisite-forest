    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <div class="form-group required">
          <label class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label" for="input-to-name"><?php echo $entry_to_name; ?></label>
        ...
        <div class="form-group required">
          <label class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label" for="input-to-email"><?php echo $entry_to_email; ?></label>
          <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10">
        ...
        <div class="form-group required">
          <label class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label" for="input-from-name"><?php echo $entry_from_name; ?></label>
          <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10">
        ...
        <div class="form-group required">
          <label class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label" for="input-from-email"><?php echo $entry_from_email; ?></label>
          <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10">
        ...
        <div class="form-group required">
          <label class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label"><?php echo $entry_theme; ?></label>
          <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10">
        ...
        <div class="form-group">
          <label class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label" for="input-message"><span data-toggle="tooltip" title="<?php echo $help_message; ?>"><?php echo $entry_message; ?></span></label>
          <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10">
            <textarea name="message" cols="40" rows="5" id="input-message" class="form-control"><?php echo $message; ?></textarea>
          </div>
        </div>
        <div class="form-group">
          <label class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label" for="input-amount"><span data-toggle="tooltip" title="<?php echo $help_amount; ?>"><?php echo $entry_amount; ?></span></label>
          <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10">
