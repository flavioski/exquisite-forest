    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <form class="form-horizontal">
        <div class="form-group">
          <label class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label" for="input-code"><?php echo $entry_code; ?></label>
          <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10">
            <textarea cols="40" rows="5" placeholder="<?php echo $entry_code; ?>" id="input-code" class="form-control"><?php echo $code; ?></textarea>
          </div>
        </div>
        <div class="form-group">
          <label class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label" for="input-generator"><span data-toggle="tooltip" title="<?php echo $help_generator; ?>"><?php echo $entry_generator; ?></span></label>
          <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10">
            <input type="text" name="product" value="" placeholder="<?php echo $entry_generator; ?>" id="input-generator" class="form-control" />
          </div>
        </div>
        <div class="form-group">
          <label class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label" for="input-link"><?php echo $entry_link; ?></label>
          <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10">
