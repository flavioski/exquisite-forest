      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
          ...
          <div class="form-group">
            <label class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label" for="input-tax"><?php echo $entry_tax; ?></label>
            <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10">
              <input type="text" name="tax" value="<?php echo $tax; ?>" placeholder="<?php echo $entry_tax; ?>" id="input-tax" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label"><?php echo $entry_payment; ?></label>
            <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10">
              <div class="radio">
                <label>
          ...
          <div class="form-group payment" id="payment-cheque">
            <label class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label" for="input-cheque"><?php echo $entry_cheque; ?></label>
            <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10">
          ...
          <div class="form-group payment" id="payment-paypal">
            <label class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label" for="input-paypal"><?php echo $entry_paypal; ?></label>
            <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10">
          ...
          <div class="payment" id="payment-bank">
            <div class="form-group">
              <label class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label" for="input-bank-name"><?php echo $entry_bank_name; ?></label>
              <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10">
            ...
            <div class="form-group">
              <label class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label" for="input-bank-branch-number"><?php echo $entry_bank_branch_number; ?></label>
              <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10">
            ...
            <div class="form-group">
              <label class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label" for="input-bank-swift-code"><?php echo $entry_bank_swift_code; ?></label>
              <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10">
            ...
            <div class="form-group">
              <label class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label" for="input-bank-account-name"><?php echo $entry_bank_account_name; ?></label>
              <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10">
            ...
            <div class="form-group">
              <label class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label" for="input-bank-account-number"><?php echo $entry_bank_account_number; ?></label>
              <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10">
